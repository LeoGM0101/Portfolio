...
def calcular_valor_janeiro(total_anual, fatores_crescimento, dados_historicos):
    ...
    valor_janeiro = total_anual
    for fator in fatores_crescimento[:4]:
        valor_janeiro /= fator
...
def mensalizar_valor_anual(valor_anual, fatores_crescimento, dados_historicos):
    ...
    valor_janeiro = calcular_valor_janeiro(valor_anual, fatores_crescimento, dados_historicos)
...
total_anual = 6165145224.29  # substituir pelo valor anual desejado


# Aplicar os fatores de crescimento para mensalizar o valor anual
valores_mensais = mensalizar_valor_anual(total_anual, fatores_crescimento, dados_historicos)
