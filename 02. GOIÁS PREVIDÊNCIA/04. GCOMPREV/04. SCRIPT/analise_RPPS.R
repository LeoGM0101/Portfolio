...
RGPS_ENVIADOS.PARA.RPPS.GO = read_excel("Z:/GERENCIA/DEMANDAS/2024/13.GCOMPREV/03. LIXO/Banco de dados RGPS_V02.xlsx", 
                                        sheet = "ENVIADOS PARA RPPS GO" ,
                                        col_types = c("date", "numeric","numeric","numeric"))

RGPS_ENVIADOS.PELO.RPPS.GO = read_excel("Z:/GERENCIA/DEMANDAS/2024/13.GCOMPREV/03. LIXO/Banco de dados RGPS_V02.xlsx", 
                                        sheet = "ENVIADOS PELO RPPS GO" ,
                                        col_types = c("date", "numeric","numeric","numeric"))
                                        
# BANCOS DE DADOS RPPS
RPPS_ENVIADOS.PARA.RPPS.GO = read_excel("Z:/GERENCIA/DEMANDAS/2024/13.GCOMPREV/03. LIXO/Banco de dados RPPS_V02.xlsx", 
                                        sheet = "ENVIADOS PARA RPPS GO" ,
                                        col_types = c("date", "numeric","numeric","numeric"))

RPPS_ENVIADOS.PELO.RPPS.GO = read_excel("Z:/GERENCIA/DEMANDAS/2024/13.GCOMPREV/03. LIXO/Banco de dados RPPS_V02.xlsx", 
                                        sheet = "ENVIADOS PELO RPPS GO" ,
                                        col_types = c("date", "numeric","numeric","numeric"))


class(RGPS_ENVIADOS.PARA.RPPS.GO$COMPETENCIA)
RGPS_ENVIADOS.PARA.RPPS.GO$COMPETENCIA = as.Date(RGPS_ENVIADOS.PARA.RPPS.GO$COMPETENCIA)
