...
path <- "Z:/GERENCIA/RELATÓRIO DE HIPÓTESES/2022/MORTALIDADE/OBITO_v01.xlsx"

hc <- read_xlsx(path, sheet = 11) #Homens civis 2019
mc <- read_xlsx(path, sheet = 12) #Mulheres civis 2019
hm <- read_xlsx(path, sheet = 13) #Homens militares 2019
