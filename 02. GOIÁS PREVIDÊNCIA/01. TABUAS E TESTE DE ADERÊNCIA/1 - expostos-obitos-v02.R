...
obitos2023 = read_excel("obitos_10_2023.xlsx")
#------------------------------------------------------------------------------#
...
#openxlsx::write.xlsx(lista_soma, file="Z:/GERENCIA/RELATÓRIO DE HIPÓTESES/2022/RPPS/MORTALIDADE/01. TABUAS E TESTE DE ADERÊNCIA/expostos e obitos.xlsx")
